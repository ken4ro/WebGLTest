...
public class ConnectionManager : SingletonBase<ConnectionManager>
{
    ...
    {
        switch (GlobalState.Instance.CurrentConnectionType.Value)
        {
            case GlobalState.ConnectionType.WebRTC:
                _connection = new WebRTCManager();
                break;
            case GlobalState.ConnectionType.Local:
                _connection = new LocalConnectionManager();
                break;
            default:
                break;
        }
